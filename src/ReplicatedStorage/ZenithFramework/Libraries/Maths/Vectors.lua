...
function Vectors.vectorToString(vector)
	assert(typeof(vector) == "Vector2" or typeof(vector) == "Vector3", "Vector arguments needs to be a Vector2 or a Vector3")
...
function Vectors.checkWithinBounds(vector, lowerXBound, upperXBound, lowerYBound, upperYBound)
	assert(typeof(vector) == "Vector2", "Vector arguments needs to be a Vector2")
