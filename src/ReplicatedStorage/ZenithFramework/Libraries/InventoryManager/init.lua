...
function InventoryManager.getContentSize(userId, inventoryName)
	return Llama.Dictionary.length(InventoryManager.getInventory(userId, inventoryName))
end
...
if RunService:IsServer() then
	...
	function InventoryManager.removeItem(userId, inventoryName, category, item)
		...
		RoduxStore:dispatch(changeInventoryItem(userId, inventoryName or "Inventory", category, item, Llama.None))
